...
const Ouroboros = React.createClass({
	render(){
		return(	
			<g>
				<path className="ouroboros__fill ouroboros__stroke--bold" d="M206.3,452.1c-23.8-2-50.4-10-70.8-21l-24.4,14.3l0.2-30.2c-19.4-14.8-36.2-33.7-48.9-55.1H35.6L50,335.7
				...
				<path className="ouroboros__stroke ouroboros__fill--none" d="M202.3,414.8C123.7,406.5,60,339.2,60,258.4c0-86.4,70-156.4,156.4-156.4c86.4,0,156.4,70,156.4,156.4
				...
				<polyline className="ouroboros__stroke ouroboros__fill--none" points="230.4,412.3 236.4,425.7 246.2,412.8 254.1,427.4 264.1,414.1 271.6,428.7 285.4,408.9 289.5,433.5 
					277.5,469.7 273.1,447.1 236.3,445.8 223,461.4 224.8,451.5 197.7,475.9 206.3,452.1 "/>
				<circle className="ouroboros__stroke ouroboros__fill--none" cx="216.7" cy="414.8" r="6.4"/>
				<circle className="ouroboros__stroke--bold ouroboros__fill--none" cx="216.5" cy="414.8" r="14.2"/>
				<circle className="ouroboros__stroke ouroboros__fill--none" cx="216.7" cy="414.8" r="3.9"/>
				<polyline className="ouroboros__stroke ouroboros__fill--none" points="184.7,390.8 189,365.7 212.8,381.5 258.6,351.2 258.1,329.5 277.7,357.7 277.7,381.5 259.2,371.9 
					256.7,392.5 239.3,387 237.9,406.8 225.6,404 "/>
				<path className="ouroboros__stroke ouroboros__fill--none" d="M197.3,402.9c-13.8-2.1-40.8-12.2-53.2-18.4l9.3-17.1l-0.3,0.4l-16.8,9.6c-16.4-9.9-34.1-29.6-44.1-47l15.8-9.6
					...
					l-0.1-0.1l15.7,9.9l0.1,0.2H84.9c0.5,19.2,4.9,38.5,13.6,56.4l0.2,0l18.6,0.7l-0.7,0.4l-13.4,7.7c10,17.3,24.1,31.1,40.5,41l0,0
					l16.4-8.7l-0.2,0.4l-7.6,13.1c12.3,6.2,19.7,10,33.5,12.2"/>
				<polyline className="ouroboros__stroke ouroboros__fill--none" points="258.6,351.2 216.7,390.8 184.7,390.8 203.6,408.9 "/>
			</g>
		)
	}
})
