	...
	render(){
		return(
			<g>
				...
				<path id="bg22" className="background__line outer" d="M95,734.6l-0.2-284.3l-33.3-33.3l0.2-48.4l17.1-17.6l-0.1-45.4l-17.1-17.6l-0.2-48.4l33.2-33.3
					l0.2-284.4"/>
				...
				<path id="bg19" className="background__line middle" d="M98.1,735.1l0.5-160.9l11.3-11.1l0.2-44.5l-29-29v-346l29-29l-0.2-20.9L98.5,82.5L98-78.4"/>
				...
				<path id="bg24" className="background__line middle" d="M141.5,736.1V451.8l-32.9-33v-50.2l-9.4-9.4l-0.1-60l9.4-9.4V238l32.9-33V-79.4"/>
